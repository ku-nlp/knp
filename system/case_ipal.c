...
char *GENERAL_SOTO_WORDS ="364:1／1998:1／9648:1／245:1／1646:1／863:1／818:1／610:1／125:1／152+53:1／4560:1／1454:1／301:1／69:1／428:1／3138:1／15659:1／865:1／149:1／218:1／5009:1／3733:1／1421:1／93:1／3456:1／624:1／92:1／667:1／657:1／486:1／1458:1／213:1／162:1／305:1／4147:1／3894:1／1468:1／362:1／1048:1／1800:1／1079:1／832:1／367:1／425:1／3336:1／2148:1／138:1／1707:1／2169:1／623:1／436:1／144:1／135:1／1930:1／98:1／473:1／1096:1／1793:1／521:1／532:1／1526:1／209:1／2010:1／1423:1／933:1／1319:1／882:1／29:1／30:1／1291:1／877:1／4891:1／300:1／87:1／3063:1／817:1／4451:1／522:1／27:1／12195:1／385:1／20334:1／256:1／256:1／180:1／3708:1／2917:1／34:1／901:1／2678:1／144:1／6402:1／22733:1／356:1／16:1／2583:1／472:1／529:1／290:1／110:1／131:1／2306:1／3976:1／148:1／2221:1／2422:1／9430:1／873:1／1133:1";
/* 副詞的名詞「中/なか:1」は保留 */
...
/*==================================================================*/
{
    ...
    CASE_FRAME *cf_ptr;
    TAG_DATA *cbp;
    int f_num = 0, size, match, c, i, cf_found_flag = 0, mrph_begin_num, mrph_end_num;
    ...
    for (i = t_ptr->mrph_num - 1; i >= 0; i--) {
        ...
        while (fp) {
            if (!strncmp(fp->cp, "LD-type=CF", 10) && (cp = strstr(fp->cp, "Address="))) {
                ...
                if (vtype && strncmp(vtype, cp, strlen("名"))) {
                    fp = fp->next;
                    continue;
                }
...
/*==================================================================*/
{
    ...
    if (OptCaseFlag & OPT_CASE_CF_USE_ID) { /* 代表表記をIDに変換 */
        ...
        if (rep_id[0]) {
            ...
            /* return 0; 変換できないものは以下でそのまま引く (<主体>) */
        }
    }
