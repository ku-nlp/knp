...
/*==================================================================*/
      void print_restrict_matrix(SENTENCE_DATA *sp, int L_B_pos)
/*==================================================================*/
{
    int i, j;
...
/*==================================================================*/
{
    ...
    */
    ...
    if (_check_para_d_struct(sp, 0, ptr->L_B, FALSE, 0, NULL) == FALSE) {
    ...
    for (j = ptr->L_B + 2; j < sp->Bnst_num; j++)
      if (_check_para_d_struct(sp, ptr->L_B + 1, j, FALSE, 0, NULL) == FALSE)
	for (i = 0; i <= ptr->L_B; i++) {
	    restrict_matrix[i][j] = 0;
	}
    ...
    if (OptDisplay == OPT_DEBUG)
	print_matrix(sp, PRINT_RSTD, ptr->L_B);
}
