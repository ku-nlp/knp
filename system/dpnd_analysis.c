...
/*==================================================================*/
{
	...
	root_prob = (lamda_root * lex_root_prob[0] / lex_root_occur[0]) + ((1 - lamda_root) * (pos_root_prob[0] / pos_root_occur[0]));
    }
    else if (pos_rule != NULL) {
	root_prob = (1 - lamda_root) * (pos_root_prob[0] / pos_root_occur[0]);
    }
    else {
	root_prob = 0;
    }
